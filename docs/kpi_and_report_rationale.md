...
| Platform | Fabric Capacity State | Paused after handover | Azure Fabric Fabric capacity running or paused state. | Cloud cost control is part of senior BI ownership. | Whether proof infrastructure is still consuming Azure credit. | Resume only for refresh/demo; suspend after review. | Cost Handover, Final Completion Report |
